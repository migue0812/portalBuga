...
<li class="sub-menu">
    ...
    <ul class="sub">
        ...
        <li class="active"><a href="{{url('admin/categoria/listar')}}">Listar</a></li>
    </ul>
</li>
<li class="sub-menu">
    <a href="javascript:;" >
                    ...
                    <div class="col-md-12">
                        <div class="content-panel table-responsive">
                            ...
                            <table class="table table-striped table-advance table-hover">
                                ...
                                <hr>
                                <form class="navbar-form navbar-left" role="search" method="post" action="{{url('admin/sitio/filtrositio')}}">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                            <a title="Habilitar" class="btn btn-success btn-xs" href="{{url('admin/categoria/habilitar/' . $categoria->cat_id)}}"><i class="fa fa-check"></i></a>
                                            @endif
                                        </td>
                                    </tr>
