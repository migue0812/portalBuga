    ...
    <div class="alert alert-info alert-dismissible center-block" role="alert">{{Session::get("habilitar")}}</div>
                @endif 
                                <table class="table table-striped table-advance table-hover">
                                    ...
                                    <hr>
                                    <form class="navbar-form navbar-left" role="search" method="post" action="{{url('admin/sitio/filtro')}}">
            ...
            <input type="text" class="form-control " placeholder="Buscar" id="buscar" name="buscar">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th><i class="fa fa-bullhorn"></i> Subcategoría</th>
                                            <th><i class="fa fa-bullhorn"></i> Dirección</th>
                                            <th><i class="fa fa-bullhorn"></i> Teléfono</th>
