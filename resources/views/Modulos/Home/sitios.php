                ...
                <div class="row ">
                    ...
                    <div class="col-md-5 portfolio-item">
                       ...
                       <hr class="tagline-divider-cont">
                        ...
                        <a href="<?php echo url("home/sitios/det") ?>" class="btn btn-primary"><b title="Ver mas"class="icon-plus fa-fw"></b></a>
...
<div class="container">
    <div class="row">
        <div class="box">
            ...
            <div class="col-md-4 portfolio-item">
                <div id="tituloalz"><h2>La María</h2></div>
                <a href="#">
                    <img class="img-responsive" src="<?php echo asset("img/Holmes.png") ?>">
                </a>        
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam viverra euismod odio, gravidas pellentesque urna varius vitae...</p>
                <a href="<?php echo url("home/sitios/det") ?>" class="btn btn-primary"><b title="Ver mas"class="icon-plus fa-fw"></b></a>
               <a href="<?php echo url("itinerario/sitios") ?>" class="btn btn-primary"><b title="Itinerario" class="icon-direction fa-fw"></b></a>
            </div> 
