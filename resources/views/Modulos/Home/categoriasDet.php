...
<div class="container">
    <div class="box">
        <div>
            <div class="visitNav">
                <div>
                    <h2 style="text-align: center;">Detalle Categoria</h2>
                </div>
            </div>
            ...
            <div>
                <div class="row ">
                    ...
                    <div class="col-sm-12  portfolio-item">
                        <h2 style="margin-top: 60px;">Deportes</h2>
    ...
    <div class="box">
        <div class="">
            <div class="col-lg-12">
                <div class="visitNav">
                    <div>
                        <h2 class="text-center">Que Deporte Practicar?</h2>
                    </div>
                </div>
                <hr class="tagline-divider-cont">
            </div>
            <div class="portafolio">
                <div class="col-sm-4 portfolio-item">
                    <img class="img-responsive tam" src="<?php echo asset("img/BMX.jpg") ?>" alt="">
                    <h3 style="color:blue;">
                        BMX
                    </h3>
                ...
                <div class="col-sm-4 portfolio-item">
                    <img class="img-responsive tam" src="<?php echo asset("img/futbol.jpg") ?>" alt="">
                    <h3 style="color:blue;">
                        Futbol
                    </h3>
                    <p class="text-justify">La ciudad de Guadalajara de Buga, cuenta con grandes escenarios deportivos, los cuales son utilizados 
                ...
                <div class="col-sm-4 portfolio-item">
                    <img class="img-responsive tam" src="<?php echo asset("img/patinaje.jpg") ?>" alt="">
                    <h3 style="color:blue;">
                        Patinaje
                    </h3>
                    <p class="text-justify">La ciudad de Guadalajara de Buga, cuenta con grandes escenarios deportivos, los cuales son utilizados 
