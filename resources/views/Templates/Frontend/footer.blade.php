    ...
    <div class="container">
        <nav class="container nav-footer">
            <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3 encuentranos">
                <h3 class="div-h3">Encuentranos</h3>
            ...
            <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3 acerca">
                <h3 class="div-h3">Acerca</h3>
                <div class="social-footer">
                    <li class="social-contactanos"><a href="<?php echo url("home/renuncia") ?>" title="Renuncia">Renuncia</a></li>
                    <li class="social-contactanos"><a href="<?php echo url("home/cookies") ?>" title="Cookies">Politicas de cookies</a></li>
                </div>
            </div>
            <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3 sitiosReferidos">
                <h3 class="div-h3">Sitios Referidos</h3>
                <div class="social-footer">
                    <li class="social-contactanos"><a href="http://www.guadalajaradebuga-valle.gov.co/index.shtml" title="AlcaldÃ­a" target="_blank">Alcaldia</a></li>
