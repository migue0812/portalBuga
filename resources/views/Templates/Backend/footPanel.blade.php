...
<script type="text/javascript" src="{{asset('panel/js/gritter/js/jquery.gritter.js')}}"></script>
<script type="text/javascript" src="{{asset('panel/js/gritter-conf.js')}}"></script>
